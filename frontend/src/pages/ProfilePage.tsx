...
import type { UserProfile } from "../services/authStorage";
...
export default function ProfilePage() {
    ...
    async function handleSubmit(event: FormEvent<HTMLFormElement>) {
        ...
        try {
            ...
            if (axios.isAxiosError(error)) {
                ...
                setMessage(payload?.message || "Erro ao atualizar perfil");
            } else {
    ...
    return (
        <AppShell title="Meu perfil" subtitle="Edite seus dados e a foto do cadastro">
